package com.example.delevryproject.data.local.preference
 ...
 * 데이터 저장 및 로드 클래스
 */
    /*  구글 로그인 : 로그인 기록 없을 시 하게 함
        유저의 로그인 기록을 SharedPreferences로 가지고 있는다.
    */
...
class AppPreferenceManager(
    ...
    companion object {
        const val PREFERENCES_NAME = "DelevryProject"
